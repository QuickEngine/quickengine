...
const _field =
	"h-9 field rounded-md px-3 text-[12.5px] text-[var(--ink-85)] outline-none transition-colors placeholder:text-[var(--ink-20)]";
						...
						<PagedTable
							...
							bulkActions={(chosen) => (
								<BulkDelete
									...
									path="/discounts"
									noun="discounts"
									invalidate={["quickdash", workspaceId, "discounts"]}
								/>
							)}
							workspaceId={workspaceId}
							layout={layout}
