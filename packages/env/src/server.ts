...
export const serverEnvSchema = clientEnvSchema.extend({
	...
	STRIPE_PRICE_STARTER_MONTHLY: emptyStringAsUndefined(z.string()),
	STRIPE_PRICE_STARTER_ANNUAL: emptyStringAsUndefined(z.string()),
	STRIPE_PRICE_PRO_MONTHLY: emptyStringAsUndefined(z.string()),
	STRIPE_PRICE_PRO_ANNUAL: emptyStringAsUndefined(z.string()),
	STRIPE_PRICE_GROWTH_MONTHLY: emptyStringAsUndefined(z.string()),
	STRIPE_PRICE_GROWTH_ANNUAL: emptyStringAsUndefined(z.string()),
	STRIPE_PRICE_TEAM_MONTHLY: emptyStringAsUndefined(z.string()),
	STRIPE_PRICE_TEAM_ANNUAL: emptyStringAsUndefined(z.string()),
