...
## [0.2.0](https://github.com/QuickEngine/quickengine/compare/mod-payments-v0.1.0...mod-payments-v0.2.0) (2026-09-06)
...
* **quickdash:** charge subscriptions, pay partners, and keep test money apart ([#455](https://github.com/QuickEngine/quickengine/issues/455)) ([a115813](https://github.com/QuickEngine/quickengine/commit/a115813e4e5fa7c736a2351078cd197cc30f2798))
* **quickdash:** check with the provider that your supplier was actually paid ([#479](https://github.com/QuickEngine/quickengine/issues/479)) ([53967aa](https://github.com/QuickEngine/quickengine/commit/53967aa708092c7517aac1d6f898d1c756233d7f))
* **quickdash:** connect a supplier and settle what you owe them automatically ([#464](https://github.com/QuickEngine/quickengine/issues/464)) ([b670429](https://github.com/QuickEngine/quickengine/commit/b6704290a2c28a3c3afde2fb53ece3bd44a650cb))
* **quickdash:** invite a supplier to set up payouts with a link that keeps working ([#480](https://github.com/QuickEngine/quickengine/issues/480)) ([b2ae85d](https://github.com/QuickEngine/quickengine/commit/b2ae85d65dc25d395ddca4dbb161994b171b76f2))
...
* **quickdash:** pay a supplier automatically when an order is paid ([#462](https://github.com/QuickEngine/quickengine/issues/462)) ([f08d2cb](https://github.com/QuickEngine/quickengine/commit/f08d2cb70ffc45f798ac71d69ecc1ea5e2e3d89f))
* **quickdash:** rehearse your whole shop in sandbox, then go live without reconnecting ([#460](https://github.com/QuickEngine/quickengine/issues/460)) ([8d23578](https://github.com/QuickEngine/quickengine/commit/8d235787efba92175dbe008300adb603e92c22d8))
...
* **quickdash:** connect a card processor in your own name, and disconnect it when you need to ([#461](https://github.com/QuickEngine/quickengine/issues/461)) ([563c4f6](https://github.com/QuickEngine/quickengine/commit/563c4f6c03d40eeebfe7b8936f7f8bc450424512))
* **quickdash:** keep sandbox records out of your live business ([#459](https://github.com/QuickEngine/quickengine/issues/459)) ([c173e65](https://github.com/QuickEngine/quickengine/commit/c173e659dcaf925a6eed173b488f1b3887d39a5b))
* **quickdash:** put stock back when you refund a customer ([#456](https://github.com/QuickEngine/quickengine/issues/456)) ([ef735dc](https://github.com/QuickEngine/quickengine/commit/ef735dc452f1ddae526f8d2b0dcae87da113a07b))
* **quickdash:** show a customer their own order, and issue keys that work ([#470](https://github.com/QuickEngine/quickengine/issues/470)) ([ef0e029](https://github.com/QuickEngine/quickengine/commit/ef0e029ff0fb67f56565a5d54429fe2ae15244ed))
