...
/**
 * Theme for the marketing site: light / dark / system, persisted, with the class
 * toggled on `<html>`.
 *
 * Replaces `next-themes`, which is a Next-specific package. The behaviour is the
 * same and small enough not to warrant a dependency: the site is dark-first,
 * follows the OS when set to `system`, and `.light` overrides live in `brand.css`.
 *
