import type { getWorkspaceReportDto } from "@quickengine/mod-reporting-analytics";
import type { ReactNode } from "react";
import Link from "../compat/router-link";

export const REPORT_RANGE_PRESETS = [7, 30, 90, 365] as const;
...
export type WorkspaceReport = Awaited<ReturnType<typeof getWorkspaceReportDto>>;
		...
		<section className="mt-8 space-y-6">
			<div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm">
				...
				<div className="flex items-center gap-2">
					...
					{REPORT_GRANULARITIES.map((option) => (
						<Link
							key={option}
				...
				<span className="text-muted-foreground text-xs">
					Times in {timeZone}. Currencies are never combined.
				</span>
			</div>
